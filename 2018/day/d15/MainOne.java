...
public class MainOne {
	...
	public static void main(String[] args) {
		...
		File file = new File("src/day/d15/luka_input.txt");
...
//			}
			...
			while (it.hasNext()) {
				Player p = it.next();
			//	System.out.println("provjeravam za igraca: " + p.toString());
				...
				Player attacked = attack(enemyList);
				if(attacked != null) {
	...
	private static Player attack(List<Player> enemyList) {
